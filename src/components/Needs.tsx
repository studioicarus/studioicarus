...
export default function Needs() {
  return (
    <section id="needs" className="bg-white pb-16 pt-14 sm:pb-20 lg:pb-24 lg:pt-16">
      <Container>
        <Reveal>
            ...
            <li key={lines.join(' ')}>
              <Reveal delay={i * 70}>
                <a href="#contact" className="group flex flex-col items-center text-center">
                  <span className="grid h-[84px] w-[84px] place-items-center rounded-[28px] bg-brand-50 shadow-[0_0_0_7px_rgba(240,245,255,0.75)] transition duration-300 group-hover:-translate-y-1 group-hover:bg-brand-100 lg:h-[120px] lg:w-[120px] lg:rounded-[36px]">
                    <Icon strokeWidth={1.4} className="h-[36px] w-[36px] text-brand lg:h-[56px] lg:w-[56px]" aria-hidden />
                  </span>
