/** Text wordmark used in the header and footer: ICARUS in white, X in electric blue. */
export default function Logo({ className = '', size = 'md' }: { className?: string; size?: 'md' | 'lg' }) {
  ...
  return (
    <a href="#top" aria-label="ICARUS X — home" className={`group relative inline-flex items-baseline text-white ${className}`}>
