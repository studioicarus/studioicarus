...
export default function WhyUs() {
  return (
    <section id="why" className="bg-paper-light py-16 sm:py-20 lg:pb-24 lg:pt-[88px]">
      <Container>
        <Reveal>
        ...
        <ul className="mt-10 grid gap-10 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-10">
          {why.map(({ title, text, icon: Icon }, i) => (
            <li key={title}>
              <Reveal delay={i * 90}>
                <span className="grid h-14 w-14 place-items-center rounded-full bg-brand-50 text-brand-600 shadow-[0_0_0_6px_rgba(255,255,255,0.45)] lg:h-[84px] lg:w-[84px]">
